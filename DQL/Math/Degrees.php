...
/**
 * Degrees ::= "DEGREES" "(" SimpleArithmeticExpression ")"
 *
 * @author Sebastian Kuhlmann <zebba@hotmail.de>
 * @package Alameda\Bridge\Doctrine\DQL
 */
final class Degrees extends FunctionNode
{
    ...
    {
        return sprintf('DEGREES(%s)', $walker->walkSimpleArithmeticExpression($this->x));
    }
} 