...
/**
 * Radians ::= "RADIANS" "(" SimpleArithmeticExpression ")"
 *
 * @author Sebastian Kuhlmann <zebba@hotmail.de>
 * @package Alameda\Bridge\Doctrine\DQL
 */
final class Radians extends FunctionNode
{
    ...
    {
        return sprintf('RADIANS(%s)', $walker->walkSimpleArithmeticExpression($this->x));
    }
} 